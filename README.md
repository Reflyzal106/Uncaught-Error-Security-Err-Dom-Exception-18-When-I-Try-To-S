# [SOLVED] Uncaught-Error-Security-Err-Dom-Exception-18-When-I-Try-To-S
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/uncaught-error-security-err-dom-exception-18-when-i-try-to-s)
>
...
Verify that the domain and port number in your cookie settings are correct and properly formatted.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/uncaught-error-security-err-dom-exception-18-when-i-try-to-s)**
